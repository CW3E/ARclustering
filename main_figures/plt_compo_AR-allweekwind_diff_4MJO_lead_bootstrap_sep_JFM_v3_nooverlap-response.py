...
for wind in np.arange(1,2): #week window
    ...
    if wind==1:
        cslev=[-40,-30,-20,-10,-5,-1,-0.1,0,0.1,1,5,10,20,30,40]
...
#_------xzx1
allclimate=np.load('/Users/zhiqiyang/Documents/A-ucsd-postdoc/nooverlap/comprad_AR'+str(wind)+'week_indp_'+month+'_1982alldomain_bootstrap_nooverlap.npy')
...
cs=m.contourf(x1,y1,(compMJO1-climat)/climat*100,cslev,cmap=cmap,extend='both')
plt.title('Composite lead5days MJO1&8_'+str(wind)+'week ARs ('+month+')',fontsize=fs)
...
cs=m.contourf(x1,y1,(compMJO2-climat)/climat*100,cslev,cmap=cmap,extend='both')
plt.title('Composite lead5days MJO2&3_'+str(wind)+'week ARs ('+month+')',fontsize=fs)
...
cs=m.contourf(x1,y1,(compMJO3-climat)/climat*100,cslev,cmap=cmap,extend='both')
plt.title('Composite lead5days MJO4&5_'+str(wind)+'week ARs ('+month+')',fontsize=fs)
...
cs=m.contourf(x1,y1,(compMJO4-climat)/climat*100,cslev,cmap=cmap,extend='both')
plt.title('Composite lead5days MJO6&7_'+str(wind)+'week ARs ('+month+')',fontsize=fs)
...
savefig('CompoMJO4comb_'+str(wind)+'week_1982-2021indp_diff_amp1lead5_'+month+'_nooverlap_response.pdf',bbox_inches = 'tight')
plt.show()
