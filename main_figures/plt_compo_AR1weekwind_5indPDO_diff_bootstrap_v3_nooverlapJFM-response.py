...
month2='JFM' #'JFM' nov2mar NDJ
month3='JFM' #'JFM' nov2mar NDJ
...
#===========pdo======!!!!!
    ...
    climatpdo=np.load('/Users/zhiqiyang/Documents/A-ucsd-postdoc/nooverlap/ERA5all_num'+str(wind)+'week_indp_'+month+'_1940alldomain_bootstrap_nooverlap.npy')
    ...
    allclimate=np.load('/Users/zhiqiyang/Documents/A-ucsd-postdoc/nooverlap/ERA5comprad_AR'+str(wind)+'week_indp_'+month+'_1940alldomain_bootstrap_nooverlap.npy')
